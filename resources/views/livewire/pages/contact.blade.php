                        ...
                        <ul class="list-unstyled contact-details__info">
                            <li>
                                ...
                                <div class="text">
                                    ...
                                    <a href="tel:0112413841"><span></span> +94 (0)11 241 3841</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <h6>Write email</h6>
                                    <a href="mailto:info@simple-engineering.lk">info@simple-engineering.lk</a>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <h6>Visit us</h6>
                                    <span>664/7, Suhanda Mawatha, <br/>
                                        I Jothipala Mawatha,
                                        Malabe, Sri Lanka.</span>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                    <span class="lnr-icon-arrow"></span>
                                </div>
                                <div class="text">
                                    <h6>Opening Hours</h6>
                                    <span>Monday – Saturday:8:00 AM – 5:00 PM <br/>
                                       Sunday: Closed</span>
                                </div>
                            </li>
                        </ul>
